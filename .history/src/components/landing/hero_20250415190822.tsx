  ...
  return (
    <section className="relative w-full pt-30 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Background image */}
        <div className="absolute inset-0 bg-[url('https://4kwallpapers.com/images/wallpapers/landscape-macbook--10760.jpg')] bg-cover bg-center opacity-80 dark:opacity-60"></div>
