  ...
  return (
    <section className="relative w-full pt-30 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Background image */}
        <div className="absolute inset-0 bg-[url('https://th.bing.com/th/id/OIP.Y_7DCxRazRItz3c-5P07IAHaEJ?w=960&h=538&rs=1&pid=ImgDetMain')] bg-cover bg-center opacity-80 dark:opacity-60"></div>
