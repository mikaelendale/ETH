  ...
  return (
    <section className="relative w-full pt-30 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Background image */}
        <div className="absolute inset-0 bg-[url('https://cdn1.matadornetwork.com/blogs/1/2021/01/Ethiopia-landscape-3.jpg')] bg-cover bg-center opacity-60 dark:opacity-70"></div>
