  ...
  return (
    <section className="relative w-full pt-30 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Background image */}
        <div className="absolute inset-0 bg-[url('https://th.bing.com/th/id/R.40fe6814864c6df63a4dfb7164971f45?rik=i5osHqNJr61FPg&pid=ImgRaw&r=0')] bg-cover bg-center opacity-80 dark:opacity-60"></div>
