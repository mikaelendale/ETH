  ...
  return (
    <section className="relative w-full pt-30 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Background image */}
        <div className="absolute inset-0 bg-[url('https://th.bing.com/th/id/R.10bbae16225258c17cd009233b218412?rik=YMS%2f%2bmrz9EbiNQ&riu=http%3a%2f%2ffc07.deviantart.net%2ffs38%2ff%2f2008%2f344%2f0%2f4%2fLook_a_like_mac_wallpaper_by_Freak_o.jpg&ehk=7nQkn%2bpuETa2jeA9F7f2pVOXT%2bqfvcCmx5r1V26zub8%3d&risl=&pid=ImgRaw&r=0')] bg-cover bg-center opacity-80 dark:opacity-60"></div>
