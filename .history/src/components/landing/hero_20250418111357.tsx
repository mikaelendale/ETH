  ...
  return (
    <section className="relative w-full pt-30 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Background image */}
        <div className="absolute inset-0 bg-[url('https://s-media-cache-ak0.pinimg.com/736x/99/be/d7/99bed70a62eaebf72ada2e16c361f8cc--textures-patterns-fall-leaves.jpg')] bg-cover bg-center opacity-80 dark:opacity-60"></div>
