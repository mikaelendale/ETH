...
import { GalleryVerticalEnd, ArrowLeft, CheckCircle, ArrowRight } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Label } from "@/components/ui/label"
import { ModernInput } from "./ui-components"
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-6">
                <div className="grid gap-2">
                  ...
                  <ModernInput id="email-display" type="email" value={email} disabled variant="filled" />
                </div>
        ...
        <div className="flex flex-col gap-6">
          <form onSubmit={handleOtpSubmit}>
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-6">
                <div className="grid gap-2">
                  <Label htmlFor="email-display-2" className="text-sm font-medium">
                    Email
                  </Label>
                  <ModernInput id="email-display-2" type="email" value={email} disabled variant="filled" />
                </div>

                <div className="grid gap-2">
                  <Label htmlFor="phone-display" className="text-sm font-medium">
                    Phone Number
                  </Label>
                  <ModernInput id="phone-display" type="tel" value={phoneNumber} disabled variant="filled" />
                </div>
          ...
          <div className="text-balance text-center text-sm">
            {timeLeft > 0 ? (
              <span className="text-muted-foreground">
                Didn't receive code? Resend in <span className="font-medium text-foreground">{timeLeft}s</span>
              </span>
            ) : (
              <button type="button" onClick={handleResendCode} className="text-primary hover:underline font-medium">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="flex flex-col items-center gap-6">
              ...
              <p className="text-center text-muted-foreground max-w-xs">
                Welcome back, <span className="font-medium text-foreground">{email}</span>. You have successfully logged
                in to your account.
              </p>
            </div>
