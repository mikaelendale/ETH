...
export function LoginSuccess({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
      ...
      <div className="flex flex-col items-center gap-8">
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="text-center text-muted-foreground max-w-xs">
            Welcome back, <span className="font-medium text-foreground">{email}</span>. You have successfully logged in
            to your account.
          </p>
        </div>
